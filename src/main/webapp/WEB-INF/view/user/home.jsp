...
<<<<<<< HEAD
                ...
                <div class="dropdown d-none" id="myDropItem">
                    ...
                    <div class="dropdown-menu rounded">
                        ...
                        <a href="#" class="dropdown-item"><i class="fas fa-power-off me-2" onClick="LogOut()"></i> Log Out</a>
                    </div>
                </div>
...
<div class="container-fluid position-relative p-0">
    <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
        <a href="" class="navbar-brand p-0">
            ...
            <!-- <img src="${pageContext.request.contextPath}/images/user/logo.png" alt="Logo"> -->
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="notification nav-item nav-link" id = "NotificationBell">
                    <!-- Icon chuông -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                         class="bi bi-bell" viewBox="0 0 16 16">
                        <path
                                d="M8 16a2 2 0 0 0 1.985-1.75H6.015A2 2 0 0 0 8 16zm6-6a1 1 0 0 1-1-1V7c0-2.304-1.233-4.42-3.225-5.412A.5.5 0 0 1 9.5 1c0-.28-.22-.5-.5-.5s-.5.22-.5.5a.5.5 0 0 1-.275.088C5.233 2.58 4 4.696 4 7v2a1 1 0 0 1-1 1H2a1 1 0 0 1 0 2h12a1 1 0 0 1 0-2h-1z" />
                    </svg>
    ...
    <div class="container-fluid about py-5">
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-7"
                     style="background: linear-gradient(rgba(255, 255, 255, .8), rgba(255, 255, 255, .8)), url(${pageContext.request.contextPath}/images/user/about-img.jpg);">
                        ...
                        <div class="row g-4">
                                ...
                                <div class="row g-4">
                                    <div class="col-lg-6">
                                        <div class="destination-img">
                                            <img class="img-fluid rounded w-100" src="${pageContext.request.contextPath}/images/user/destination-1.jpg" alt="">
                                            ...
                                            <div class="search-icon">
                                                <a href="${pageContext.request.contextPath}/images/user/destination-1.jpg" data-lightbox="destination-1"><i
                                    ...
                                    <div class="col-lg-6">
                                        <div class="destination-img">
                                            <img class="img-fluid rounded w-100" src="${pageContext.request.contextPath}/images/user/destination-2.jpg" alt="">
                                            <div class="destination-overlay p-4">
                                                <a href="#"
                                                   class="btn btn-primary text-white rounded-pill border py-2 px-3">20
                                                    Photos</a>
                                            ...
                                            <div class="search-icon">
                                                <a href="${pageContext.request.contextPath}/images/user/destination-2.jpg" data-lightbox="destination-2"><i
                                                        class="fa fa-plus-square fa-1x btn btn-light btn-lg-square text-primary"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="destination-img">
                                            ...
                                            <div class="search-icon">
                                                <a href="${pageContext.request.contextPath}/images/user/destination-7.jpg" data-lightbox="destination-7"><i
                                                        class="fa fa-plus-square fa-1x btn btn-light btn-lg-square text-primary"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="destination-img">
                                            ...
                                            <div class="search-icon">
                                                <a href="${pageContext.request.contextPath}/images/user/destination-8.jpg" data-lightbox="destination-8"><i
                                                        class="fa fa-plus-square fa-1x btn btn-light btn-lg-square text-primary"></i></a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-4">
                                <div class="destination-img h-100">
                                    ...
                                    <div class="search-icon">
                                        <a href="${pageContext.request.contextPath}/images/user/destination-9.jpg" data-lightbox="destination-4"><i
                                                class="fa fa-plus-square fa-1x btn btn-light btn-lg-square text-primary"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="destination-img">
                                    ...
                                    <div class="search-icon">
                                        <a href="${pageContext.request.contextPath}/images/user/destination-4.jpg" data-lightbox="destination-4"><i
                                                class="fa fa-plus-square fa-1x btn btn-light btn-lg-square text-primary"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="destination-img">
                                    ...
                                    <div class="search-icon">
                                        <a href="${pageContext.request.contextPath}/images/user/destination-5.jpg" data-lightbox="destination-5"><i
                                                class="fa fa-plus-square fa-1x btn btn-light btn-lg-square text-primary"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="destination-img">
                                    ...
                                    <div class="search-icon">
                                        <a href="${pageContext.request.contextPath}/images/user/destination-6.jpg" data-lightbox="destination-6"><i
                                                class="fa fa-plus-square fa-1x btn btn-light btn-lg-square text-primary"></i></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-6 col-lg-4">
                                <div class="national-item">
                                    <img src="${pageContext.request.contextPath}/images/user/explore-tour-1.jpg" class="img-fluid w-100 rounded" alt="Image">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="national-item">
                                    <img src="${pageContext.request.contextPath}/images/user/explore-tour-2.jpg" class="img-fluid w-100 rounded" alt="Image">
                                    <div class="national-content">
                                        <div class="national-info">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="national-item">
                                    <img src="${pageContext.request.contextPath}/images/user/explore-tour-3.jpg" class="img-fluid w-100 rounded" alt="Image">
                                    <div class="national-content">
                                        <div class="national-info">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="national-item">
                                    <img src="${pageContext.request.contextPath}/images/user/explore-tour-4.jpg" class="img-fluid w-100 rounded" alt="Image">
                                    <div class="national-content">
                                        <div class="national-info">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="national-item">
                                    <img src="${pageContext.request.contextPath}/images/user/explore-tour-5.jpg" class="img-fluid w-100 rounded" alt="Image">
                                    <div class="national-content">
                                        <div class="national-info">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="national-item">
                                    <img src="${pageContext.request.contextPath}/images/user/explore-tour-6.jpg" class="img-fluid w-100 rounded" alt="Image">
                                    <div class="national-content">
                                        <div class="national-info">
            ...
            <div class="packages-carousel owl-carousel">
                <div class="packages-item">
                    <div class="packages-img">
                        <img src="${pageContext.request.contextPath}/images/user/packages-4.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                ...
                <div class="packages-item">
                    <div class="packages-img">
                        <img src="${pageContext.request.contextPath}/images/user/packages-2.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                        <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute"
                             style="width: 100%; bottom: 0; left: 0; z-index: 5;">
                            <small class="flex-fill text-center border-end py-2"><i
                                    class="fa fa-map-marker-alt me-2"></i>Venice - Italy</small>
                ...
                <div class="packages-item">
                    <div class="packages-img">
                        <img src="${pageContext.request.contextPath}/images/user/packages-3.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                        <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute"
                             style="width: 100%; bottom: 0; left: 0; z-index: 5;">
                            <small class="flex-fill text-center border-end py-2"><i
                                    class="fa fa-map-marker-alt me-2"></i>Venice - Italy</small>
                ...
                <div class="packages-item">
                    <div class="packages-img">
                        <img src="${pageContext.request.contextPath}/images/user/packages-1.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                        <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute"
                             style="width: 100%; bottom: 0; left: 0; z-index: 5;">
                            <small class="flex-fill text-center border-end py-2"><i
                    ...
                    <div class="row g-2">
                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-2">
                            <div class="gallery-item h-100">
                                <img src="${pageContext.request.contextPath}/images/user/gallery-1.jpg" class="img-fluid w-100 h-100 rounded" alt="Image">
                                ...
                                <div class="gallery-plus-icon">
                                    <a href="${pageContext.request.contextPath}/images/user/gallery-1.jpg" data-lightbox="gallery-1" class="my-auto"><i
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                            <div class="gallery-item h-100">
                                <img src="${pageContext.request.contextPath}/images/user/gallery-2.jpg" class="img-fluid w-100 h-100 rounded" alt="Image">
                                <div class="gallery-content">
                                    <div class="gallery-info">
                                        <h5 class="text-white text-uppercase mb-2">World Tour</h5>
                                        <a href="#" class="btn-hover text-white">View All Place <i
                                ...
                                <div class="gallery-plus-icon">
                                    <a href="${pageContext.request.contextPath}/images/user/gallery-2.jpg" data-lightbox="gallery-2" class="my-auto"><i
                                            class="fas fa-plus fa-2x text-white"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-2">
                            <div class="gallery-item h-100">
                                <img src="${pageContext.request.contextPath}/images/user/gallery-3.jpg" class="img-fluid w-100 h-100 rounded" alt="Image">
                                <div class="gallery-content">
                                    <div class="gallery-info">
                                        <h5 class="text-white text-uppercase mb-2">World Tour</h5>
                                        <a href="#" class="btn-hover text-white">View All Place <i
                                ...
                                <div class="gallery-plus-icon">
                                    <a href="${pageContext.request.contextPath}/images/user/gallery-3.jpg" data-lightbox="gallery-3" class="my-auto"><i
                                            class="fas fa-plus fa-2x text-white"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                            <div class="gallery-item h-100">
                                <img src="${pageContext.request.contextPath}/images/user/gallery-4.jpg" class="img-fluid w-100 h-100 rounded" alt="Image">
                                <div class="gallery-content">
                                    <div class="gallery-info">
                                        <h5 class="text-white text-uppercase mb-2">World Tour</h5>
                                        <a href="#" class="btn-hover text-white">View All Place <i
                                ...
                                <div class="gallery-plus-icon">
                                    <a href="${pageContext.request.contextPath}/images/user/gallery-4.jpg" data-lightbox="gallery-4" class="my-auto"><i
                                            class="fas fa-plus fa-2x text-white"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-2">
                            <div class="gallery-item h-100">
                                <img src="${pageContext.request.contextPath}/images/user/gallery-5.jpg" class="img-fluid w-100 h-100 rounded" alt="Image">
                                <div class="gallery-content">
                                    <div class="gallery-info">
                                        <h5 class="text-white text-uppercase mb-2">World Tour</h5>
                                        <a href="#" class="btn-hover text-white">View All Place <i
                                ...
                                <div class="gallery-plus-icon">
                                    <a href="${pageContext.request.contextPath}/images/user/gallery-5.jpg" data-lightbox="gallery-5" class="my-auto"><i
                                            class="fas fa-plus fa-2x text-white"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-2">
                            <div class="gallery-item h-100">
                                <img src="${pageContext.request.contextPath}/images/user/gallery-6.jpg" class="img-fluid w-100 h-100 rounded" alt="Image">
                                <div class="gallery-content">
                                    <div class="gallery-info">
                                        <h5 class="text-white text-uppercase mb-2">World Tour</h5>
                                        <a href="#" class="btn-hover text-white">View All Place <i
                                ...
                                <div class="gallery-plus-icon">
                                    <a href="${pageContext.request.contextPath}/images/user/gallery-6.jpg" data-lightbox="gallery-6" class="my-auto"><i
                                            class="fas fa-plus fa-2x text-white"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
                            <div class="gallery-item h-100">
                                <img src="${pageContext.request.contextPath}/images/user/gallery-7.jpg" class="img-fluid w-100 h-100 rounded" alt="Image">
                                <div class="gallery-content">
                                    <div class="gallery-info">
                                        <h5 class="text-white text-uppercase mb-2">World Tour</h5>
                                        <a href="#" class="btn-hover text-white">View All Place <i
                                ...
                                <div class="gallery-plus-icon">
                                    <a href="${pageContext.request.contextPath}/images/user/gallery-7.jpg" data-lightbox="gallery-7" class="my-auto"><i
                                            class="fas fa-plus fa-2x text-white"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6 col-lg-3 col-xl-2">
                            <div class="gallery-item h-100">
                                <img src="${pageContext.request.contextPath}/images/user/gallery-8.jpg" class="img-fluid w-100 h-100 rounded" alt="Image">
                                <div class="gallery-content">
                                    <div class="gallery-info">
                                        <h5 class="text-white text-uppercase mb-2">World Tour</h5>
                                        <a href="#" class="btn-hover text-white">View All Place <i
                                ...
                                <div class="gallery-plus-icon">
                                    <a href="${pageContext.request.contextPath}/images/user/gallery-8.jpg" data-lightbox="gallery-8" class="my-auto"><i
                                            class="fas fa-plus fa-2x text-white"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
                            <div class="gallery-item h-100">
                                <img src="${pageContext.request.contextPath}/images/user/gallery-9.jpg" class="img-fluid w-100 h-100 rounded" alt="Image">
                                <div class="gallery-content">
                                    <div class="gallery-info">
                                        <h5 class="text-white text-uppercase mb-2">World Tour</h5>
                                        <a href="#" class="btn-hover text-white">View All Place <i
                                ...
                                <div class="gallery-plus-icon">
                                    <a href="${pageContext.request.contextPath}/images/user/gallery-9.jpg" data-lightbox="gallery-9" class="my-auto"><i
                                            class="fas fa-plus fa-2x text-white"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6 col-lg-3 col-xl-2">
                            <div class="gallery-item h-100">
                                <img src="${pageContext.request.contextPath}/images/user/gallery-10.jpg" class="img-fluid w-100 h-100 rounded" alt="Image">
                                <div class="gallery-content">
                                    <div class="gallery-info">
                                        <h5 class="text-white text-uppercase mb-2">World Tour</h5>
                                        <a href="#" class="btn-hover text-white">View All Place <i
                                ...
                                <div class="gallery-plus-icon">
                                    <a href="${pageContext.request.contextPath}/images/user/gallery-10.jpg" data-lightbox="gallery-10" class="my-auto"><i
                                            class="fas fa-plus fa-2x text-white"></i></a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row g-4">
                    ...
                    <div class="guide-item">
                        <div class="guide-img">
                            <div class="guide-img-efects">
                                <img src="${pageContext.request.contextPath}/images/user/guide-1.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                            </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="guide-item">
                        <div class="guide-img">
                            <div class="guide-img-efects">
                                <img src="${pageContext.request.contextPath}/images/user/guide-2.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                            </div>
                            <div class="guide-icon rounded-pill p-2">
                                <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i
                                        class="fab fa-facebook-f"></i></a>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="guide-item">
                        <div class="guide-img">
                            <div class="guide-img-efects">
                                <img src="${pageContext.request.contextPath}/images/user/guide-3.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                            </div>
                            <div class="guide-icon rounded-pill p-2">
                                <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i
                                        class="fab fa-facebook-f"></i></a>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="guide-item">
                        <div class="guide-img">
                            <div class="guide-img-efects">
                                <img src="${pageContext.request.contextPath}/images/user/guide-4.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                            </div>
                            <div class="guide-icon rounded-pill p-2">
                                <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i
                                        class="fab fa-facebook-f"></i></a>
            ...
            <div class="testimonial-carousel owl-carousel">
                <div class="testimonial-item text-center rounded pb-4">
                    ...
                    <div class="testimonial-img p-1">
                        <img src="${pageContext.request.contextPath}/images/user/testimonial-1.jpg" class="img-fluid rounded-circle" alt="Image">
                    </div>
                ...
                <div class="testimonial-item text-center rounded pb-4">
                    ...
                    <div class="testimonial-img p-1">
                        <img src="${pageContext.request.contextPath}/images/user/testimonial-2.jpg" class="img-fluid rounded-circle" alt="Image">
                    </div>
                    <div style="margin-top: -35px;">
                        <h5 class="mb-0">John Abraham</h5>
                        <p class="mb-0">New York, USA</p>
                ...
                <div class="testimonial-item text-center rounded pb-4">
                    ...
                    <div class="testimonial-img p-1">
                        <img src="${pageContext.request.contextPath}/images/user/testimonial-3.jpg" class="img-fluid rounded-circle" alt="Image">
                    </div>
                    <div style="margin-top: -35px;">
                        <h5 class="mb-0">John Abraham</h5>
                        <p class="mb-0">New York, USA</p>
                ...
                <div class="testimonial-item text-center rounded pb-4">
                    ...
                    <div class="testimonial-img p-1">
                        <img src="${pageContext.request.contextPath}/images/user/testimonial-4.jpg" class="img-fluid rounded-circle" alt="Image">
                    </div>
                    <div style="margin-top: -35px;">
                        <h5 class="mb-0">John Abraham</h5>
                        <p class="mb-0">New York, USA</p>
